...
public class listSoal extends AppCompatActivity implements OnItemClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        mp = MediaPlayer.create(this, R.raw.backsound4);
        mp.setLooping(true);
        mp.setVolume(1,1);
        mp.start();
    ...
    public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
        ...
        i.putExtra("kategori", arrKat[position]);
        finish();
        mp.stop();
        startActivity(i);
    }
